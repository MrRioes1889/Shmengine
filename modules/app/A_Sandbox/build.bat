...
set compiler_flags=/LDd /MDd /MP /GS /W4 /Zc:wchar_t /Gm- /Od /Ob1 /Zc:inline /fp:precise /fp:except /errorReport:prompt /WX /Zc:forScope /RTC1 /Gd /std:c++20 /FC /WX /W4 /FC /Zi /EHsc /nologo %includes% %defines% %disabled_warnings%
