...
namespace Constants
{
	...
	inline constexpr uint32 max_mesh_name_length = 64;
	inline constexpr uint32 max_geometry_name_length = 64;
	inline constexpr uint32 max_material_name_length = 64;
	inline constexpr uint32 max_shader_name_length = 64;
	inline constexpr uint32 max_shader_stage_name_length = 64;
	inline constexpr uint32 max_shader_attribute_name_length = 64;
	inline constexpr uint32 max_shader_uniform_name_length = 64;
	inline constexpr uint32 max_texture_name_length = 64;
