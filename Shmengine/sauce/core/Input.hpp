...
namespace Input
{
    ...
    SHMAPI bool32 was_key_down(Keys key);
    SHMAPI bool32 was_key_up(Keys key);   

    SHMAPI bool32 is_mousebutton_down(Mousebuttons button);
    SHMAPI bool32 is_mousebutton_up(Mousebuttons button);
    SHMAPI bool32 was_mousebutton_down(Mousebuttons button);
