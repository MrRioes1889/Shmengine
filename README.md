...
<b>Disclaimer: This solo project is created for educational/recreational purposes exclusively and is subject to constant restructuring. Hence, older parts of the codebase can contain some less well thought out solutions compared to newer ones. Currently put on hold for a redo, built using the Odin programming language!</b><br><br>
